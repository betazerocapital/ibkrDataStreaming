...
void TestCppClient::realTimeBars()
{
	...
	//! [reqrealtimebars]
	for (int i = 0; i < 100; i++) {
		m_pClient->reqRealTimeBars(3001 + i, ContractSamples::EurGbpFx(), 5, "MIDPOINT", true, TagValueListSPtr());
	} 
...
void TestCppClient::historicalDataRequests()
{
	...
	m_pClient->reqHistoricalData(4001, ContractSamples::EurGbpFx(), queryTime, "1 D", "1 hour", "MIDPOINT", 1, 1, false, TagValueListSPtr());
